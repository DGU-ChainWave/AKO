    ...
    <div className="w-[334px] h-[360px] fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-[30px] bg-[#ffffff] border-2 border-[#ffb876] flex flex-col items-center z-50">
      <div className="my-[26px] h-auto flex flex-col gap-[20px]">
        ...
        <div className="h-[74px] flex gap-[11px]">
          <img
            src="assets/klip_logo.png"
            alt="klip logo"
            className="w-[94px] h-[75px] rounded-[14px] object-cover"
          />
          <div className="flex flex-col gap-[9px]">
            <p className="w-[190px] text-[11px] font-bold text-[#4e4e4e]">
              클립이란 클레이튼과 이더리움, 폴리곤 네트워크 등의 디지털 자산을
              안전하고 편리하게 관리할 수 있는 지갑입니다.
            </p>
            <a
              href="/useInfo"
              className="flex justify-center items-center w-[186px] h-[21px] p-1 rounded-[5px] bg-[#ff971b]"
            >
